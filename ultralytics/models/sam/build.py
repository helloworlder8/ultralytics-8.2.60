...
def build_sam2_t(model_name=None):
    ...
    return _build_sam2(
        ...
        model_name=model_name, #'sam2.1_t.pt'
    )
...
def _build_sam2(
    ...
    is_sam2_1 = model_name is not None and "sam2.1" in model_name
    sam2 = SAM2Model(
        image_encoder=image_encoder,
    ...
    if model_name is not None:
        checkpoint = attempt_download_asset(model_name)
...
def build_sam(model_pt="sam_b.pt"):
    ...
    model_builder = None
    model_pt = str(model_pt)  # 'sam2_b.pt'
    ...
    return model_builder(model_pt) #'sam2.1_t.pt'
